...
def training_loop(
    ...
    training_set_iterator = iter(torch.utils.data.DataLoader(dataset=training_set, sampler=training_set_sampler, batch_size=batch_size//num_gpus, persistent_workers=False, **data_loader_kwargs))
    if rank == 0:
        print()
